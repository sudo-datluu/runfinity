...
urlpatterns = [
    ...
    path('lobby/<int:lobby_id>/start', views.LobbyStart().as_view()),
    path('lobby/<int:lobby_id>', views.LobbyGet.as_view()),
    path('lobby/<int:lobby_id>/join', views.LobbyJoin.as_view()),
    path('lobby/<int:lobby_id>/left', views.LobbyLeft.as_view()),
